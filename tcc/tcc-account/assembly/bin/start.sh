...
JAVA_GC_OPTS="-XX:+PrintGCDetails -XX:+PrintGCDateStamps -Xloggc:/data/app/logs/tcc-account/gc.log"
...
PID=`ps -ef | grep 'java' | grep 'com.github.lyrric.tcc.account.AccountApplication' | grep -v 'grep' | awk '{print $2}'`
