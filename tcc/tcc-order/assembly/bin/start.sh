...
JAVA_GC_OPTS="-XX:+PrintGCDetails -XX:+PrintGCDateStamps -Xloggc:/data/app/logs/tcc-order/gc.log"
...
PID=`ps -ef | grep 'java' | grep 'com.github.lyrric.tcc.order.OrderApplication' | grep -v 'grep' | awk '{print $2}'`
